 ...
 *
 ...
 This is a Java Program to find median of two sorted arrays using binary search approach.
 ...
 and picking the middle one. However size of both arrays must be equal. The time complexity of the following program is O (log n).

 Here is the source code of the Java program to find median of two sorted arrays.
