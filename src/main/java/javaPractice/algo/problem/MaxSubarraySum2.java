 ...
 *
 ...
 This is a Java Program to find maximum subarray sum of an array. A subarray is a continuous portion of an array.
 The following program uses binary search approach to find the maximum subarray sum.
 The time complexity of the following program is O (n log n).

 Here is the source code of the Java program to find maximum subarray sum.
