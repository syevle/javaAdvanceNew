package javaPractice.algo.datastructure;

/**
 * This is a Java Program to implement a stack.
 * Stack is an area of memory that holds all local variables and parameters used by
 ...
 * ‘peek’ operation is also implemented returning the value of the top element without removing it.
 ...
 * The implemented stack has bounded capacity.
 ...
 Here is the source code of the Java program to implement a stack.
