package javaPractice.algo.tree;
...

{
    ...
    javaPractice.algo.tree.serch.BSTNode left, right;
    ...
    public void setLeft(javaPractice.algo.tree.serch.BSTNode n)
    ...
    public void setRight(javaPractice.algo.tree.serch.BSTNode n)
    ...
    public javaPractice.algo.tree.serch.BSTNode getLeft()
    ...
    public javaPractice.algo.tree.serch.BSTNode getRight()
...

{
    ...
    private javaPractice.algo.tree.serch.BSTNode root;
    ...
    private javaPractice.algo.tree.serch.BSTNode insert(javaPractice.algo.tree.serch.BSTNode node, int data)

    {

        if (node == null)

            node = new javaPractice.algo.tree.serch.BSTNode(data);
    ...
    private javaPractice.algo.tree.serch.BSTNode delete(javaPractice.algo.tree.serch.BSTNode root, int k)

    {

        javaPractice.algo.tree.serch.BSTNode p, p2, n;

        if (root.getData() == k)

        {

            javaPractice.algo.tree.serch.BSTNode lt, rt;
    ...
    private int countNodes(javaPractice.algo.tree.serch.BSTNode r)
    ...
    private boolean search(javaPractice.algo.tree.serch.BSTNode r, int val)
    ...
    private void inorder(javaPractice.algo.tree.serch.BSTNode r)
    ...
    private void preorder(javaPractice.algo.tree.serch.BSTNode r)
    ...
    private void postorder(javaPractice.algo.tree.serch.BSTNode r)
