package javaPractice.datastructure.mydatastructure.hash;
 ...
 *
 ...
 This is a Java Program to implement hash tables.
 A hash table (also hash map) is a data structure used to implement an associative array,
